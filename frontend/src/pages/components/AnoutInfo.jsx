    ...
    return (
        <section className='flex flex-col gap-[200px] pt-[400px]'>
            ...
            <div className="text-center">
                ...
                <div className="grid grid-cols-3 md:grid-cols-2 gap-4 pt-[48px]">
                    <a className="aboute__plus"
                    ...
                    <a className="aboute__plus"
                        ...
                        style={{background: isHovered === 3 ? '#BA93DF' : ''}}>
                            {isHovered === 3 ? 'Code Beautify — конвертер цветовых кодов' : <img src={ Codebeautify } alt="Link 1"/>}
                    </a>
                    ...
                    <a className="aboute__plus"
                        ...
                        style={{background: isHovered === 4 ? '#BA93DF' : ''}}>
                            {isHovered === 4 ? 'WhatFont — расширение, показывающее шрифты на сайтах' : <img src={ Whatfont } alt="Link 2"/>}
                    </a>
                    ...
                    <a className="aboute__plus"
                        ...
                        style={{background: isHovered === 5 ? '#BA93DF' : ''}}>
                            {isHovered === 5 ? 'Color by Fardos — расширение, показывающее цвета на сайтах' : <img src={ Colorbyfardos } alt="Link 3"/>}
                    </a>
